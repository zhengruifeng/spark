    ...
    if is_remote():
        ...
        if not isinstance(left, ConnectColumn):
            raise PySparkTypeError(
                ...
                messageParameters={"expected_type": "a Column", "arg_name": "left", "arg_type": type(left).__name__},
            )
        if not isinstance(right, ConnectColumn):
            raise PySparkTypeError(
                errorClass="NOT_EXPECTED_TYPE",
                messageParameters={"expected_type": "a Column", "arg_name": "right", "arg_type": type(right).__name__},
            )
