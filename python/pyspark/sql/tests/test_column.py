...
class ColumnTestsMixin:
    ...
    def test_validate_column_types(self):
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a Column or str", "arg_name": "col", "arg_type": "NoneType"},
        )
    ...
    def test_with_field(self):
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a Column", "arg_name": "col", "arg_type": "int"},
        )
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a str", "arg_name": "fieldName", "arg_type": "Column"},
        )
    ...
    def test_cast_negative(self):
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a DataType or str", "arg_name": "dataType", "arg_type": "int"},
        )
    ...
    def test_over_negative(self):
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a WindowSpec", "arg_name": "window", "arg_type": "int"},
        )
