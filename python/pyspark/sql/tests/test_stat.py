...
class DataFrameStatTestsMixin:
    ...
    def test_dropna(self):
        ...
        self.check_error(
            ...
            messageParameters={"expected_type": "a list, str or tuple", "arg_name": "subset", "arg_type": "int"},
        )
    ...
    def test_fillna(self):
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a bool, dict, float, int or str", "arg_name": "value", "arg_type": "list"},
        )
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a list or tuple", "arg_name": "subset", "arg_type": "int"},
        )
    ...
    def test_replace(self):
        ...
        self.check_error(
            exception=pe.exception,
            errorClass="NOT_EXPECTED_TYPE",
            messageParameters={"expected_type": "a bool, dict, float, int, str or tuple", "arg_name": "to_replace", "arg_type": "function"},
        )
