...
from pyspark.sql.conversion import (
    ...
    ArrowArrayToPandasSeriesConversion,
)
...
class ArrowStreamPandasSerializer(ArrowStreamSerializer):
    ...
    def arrow_to_pandas(
        ...
        return ArrowArrayToPandasSeriesConversion.convert(
            arrow_column,
            spark_type=spark_type or from_arrow_type(arrow_column.type, prefer_timestamp_ntz=True),
            nullable=True,
