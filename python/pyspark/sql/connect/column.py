...
class Column(ParentColumn):
    ...
    def __init__(self, expr: "Expression") -> None:
        if not isinstance(expr, Expression):
            raise PySparkTypeError(
                ...
                messageParameters={"expected_type": "an Expression", "arg_name": "expr", "arg_type": type(expr).__name__},
            )
        self._expr = expr
    ...
    def substr(
        ...
        if isinstance(length, (Column, int)):
            ...
            raise PySparkTypeError(
                errorClass="NOT_EXPECTED_TYPE",
                messageParameters={"expected_type": "a Column or int", "arg_name": "startPos", "arg_type": type(length).__name__},
            )
