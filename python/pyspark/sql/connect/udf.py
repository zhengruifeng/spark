    ...
    def __init__(
        ...
        if not callable(func):
            raise PySparkTypeError(
                ...
                messageParameters={"expected_type": "a callable", "arg_name": "func", "arg_type": type(func).__name__},
            )
        ...
        if not isinstance(returnType, (DataType, str)):
            raise PySparkTypeError(
                errorClass="NOT_EXPECTED_TYPE",
                messageParameters={
                    "expected_type": "a DataType or str",
                    "arg_name": "returnType",
        ...
        if not isinstance(evalType, int):
            raise PySparkTypeError(
                errorClass="NOT_EXPECTED_TYPE",
                messageParameters={"expected_type": "an int", "arg_name": "evalType", "arg_type": type(evalType).__name__},
            )
