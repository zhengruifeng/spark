...
class CoGroupedArrowPythonRunner(
    ...
    _leftSchema: StructType,
    _rightSchema: StructType,
    timeZoneId: String,
  ...
  protected lazy val leftSchema: StructType = ArrowUtils.checkDuplicateFieldNames(_leftSchema)
  protected lazy val rightSchema: StructType = ArrowUtils.checkDuplicateFieldNames(_rightSchema)
