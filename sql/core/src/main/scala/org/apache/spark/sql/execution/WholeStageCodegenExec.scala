...
import org.apache.spark.sql.execution.joins.{BroadcastHashJoinExec, BroadcastNestedLoopJoinExec, BroadcastSortMergeJoinExec, ShuffledHashJoinExec, SortMergeJoinExec}
...
trait CodegenSupport extends SparkPlan {
  ...
  private def variablePrefix: String = this match {
    ...
    case _: BroadcastSortMergeJoinExec => "bsmj"
