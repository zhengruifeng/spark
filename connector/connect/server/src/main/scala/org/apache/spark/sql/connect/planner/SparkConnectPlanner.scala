...
import org.apache.spark.sql.connect.service.{SparkConnectCatalogHandler, SparkConnectService, SparkConnectStreamHandler}
  ...
  def transformRelation(rel: proto.Relation): LogicalPlan = {
    val plan = rel.getRelTypeCase match {
      ...
      case proto.Relation.RelTypeCase.CATALOG =>
        // Normally, the Catalog requests are already processed in the 'CATALOG' branch in
        // SparkConnectStreamHandler#handlePlan, here still match 'CATALOG' pattern
